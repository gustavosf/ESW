...
function LoadLocalData() {
    ...
    if (gas_con == null) {
        ...
        document.getElementById("Gas_Cons")
            .value = "1.3";
    } else {
        document.getElementById("Gas_Cons")
            .value =
    ...
    if (eta_con == null) {
        ...
        document.getElementById("Eta_Cons")
            .value = "1";
    } else {
        document.getElementById("Eta_Cons")
            .value =
...
function CalcFlex() {
    var gas_con = localStorage.getItem('CalcFlex_Gas_Con');
    var eta_con = localStorage.getItem('CalcFlex_Eta_Con');
    var gas_price = document.getElementById("Gas_Price")
        .value;
    var eta_price = document.getElementById("Eta_Price")
        .value;
...
document.querySelector('#Gas_Cons')
    .addEventListener('keyup', function() {
            localStorage.setItem('CalcFlex_Gas_Con', this.value);
        }
        , false);
document.querySelector('#Eta_Cons')
    .addEventListener('keyup', function() {
